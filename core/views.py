...
class Register(View):
    ...
    def post(self, request):
        ...
        try:
            ...
            return HttpResponse("An account with this username already exists. Please log in if it's yours.")
        except:
...
class CreateProfile(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        try:
            ...
            profile = Profile(about=about, skills=skills, user=request.user)
            profile.save()
            return redirect("/members/directory/")
...
class CreateProject(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        user = request.user
        project = Project(title=title, user=user, current=is_active)
        project.save()
